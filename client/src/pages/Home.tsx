      ...
      <div className="jarvis-workspace-shell mx-auto flex w-full max-w-[1680px] flex-col gap-3 md:flex-row">
        ...
        <div className="jarvis-workspace-content min-w-0 flex-1">
          <header className="mb-3 flex min-h-14 w-full items-center justify-between gap-3 rounded-xl border border-white/10 bg-slate-950/55 px-3 py-2.5 backdrop-blur-xl sm:px-4">
            ...
            <div className="flex items-center gap-2"><div className="hidden items-center gap-2 rounded-lg border border-white/10 bg-black/20 px-3 py-2 sm:flex"><StatusDot state={coreState} /><span className="text-[11px] text-slate-400">{statusCopy[coreState]}</span></div><Link href="/virgoyt" className="flex min-h-10 items-center gap-1.5 rounded-lg border border-fuchsia-400/25 bg-fuchsia-400/[0.08] px-2.5 py-2 text-xs font-medium text-fuchsia-100 transition hover:bg-fuchsia-400/15 sm:px-3"><Bot className="size-3.5" /><span className="sm:hidden">VirgoYT</span><span className="hidden sm:inline">VirgoYT Workspace</span></Link><button onClick={startNewChat} className="hidden items-center gap-1.5 rounded-lg border border-cyan-300/25 bg-cyan-300/10 px-3 py-2 text-xs font-medium text-cyan-100 transition hover:bg-cyan-300/15 sm:flex"><Plus className="size-3.5" /> New chat</button></div>
          </header>
