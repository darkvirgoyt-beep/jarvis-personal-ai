...
describe("JarvisCommandCenter", () => {
  it("makes automatic build routing and the unconnected runner boundary visible", () => {
    ...
    const markup = renderToStaticMarkup(<JarvisCommandCenter route={routeJarvisPrompt("Build an Android app")} activity={["Jarvis ready"]} isWorking={false} onRequestRunner={requestRunner} />);
