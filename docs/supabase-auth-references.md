...
7. [Supabase JavaScript password-reset reference](https://supabase.com/docs/reference/javascript/auth-resetpasswordforemail) — documents sending a password-recovery email with an allowed application return URL.
8. [Supabase JavaScript user-update reference](https://supabase.com/docs/reference/javascript/auth-updateuser) — documents setting a replacement password only after a user has returned with a verified recovery session.
